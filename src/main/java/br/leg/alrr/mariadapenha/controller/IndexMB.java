package br.leg.alrr.mariadapenha.controller;
...
import br.leg.alrr.mariadapenha.model.Ouvinte;
import br.leg.alrr.common.persistence.acesso.UsuarioDAO;
import br.leg.alrr.mariadapenha.persistence.OuvinteDAO;
...
import br.leg.alrr.mariadapenha.model.Evento;
import br.leg.alrr.mariadapenha.model.Frequencia;
import br.leg.alrr.mariadapenha.persistence.EventoDAO;
import br.leg.alrr.mariadapenha.persistence.FrequenciaDAO;
                ...
                if (ouvinteDAO.haOvinteComCPF(ouvinte.getCpf())) {
                    ...
                    if (!usuarioDAO.haOLogin(ouvinte.getEmail())) {
                        ...
                        if (ouvinte.isPresencial()) {
                            FacesUtils.addInfoMessageFlashScoped("Na data 17/08/2021 compareça ao plenarinho para assistir ao evento!");
                        } else {
                            FacesUtils.addInfoMessageFlashScoped("Na data 17/08/2021 acesse o sistema clicando no botão \"Entrar\", no fim da página, para acompanhar o evento remotamente!");
                        }
                    } else {
